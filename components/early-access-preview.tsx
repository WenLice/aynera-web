          ...
          {submitted ? (
            ...
            <form onSubmit={submit} className="access-preview-form" noValidate onChange={(event) => {
              ...
              <div className="access-preview-fields">
                <label className="access-preview-wide">Name<input name="name" maxLength={200} required autoComplete="name" aria-invalid={!!fieldErrors.name} aria-describedby={fieldErrors.name ? "name-error" : undefined} /><FieldError name="name" message={fieldErrors.name} /></label>
